...
{
public:
	CPlaneMeshIlluminatedTextured(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, UINT nWidth = 2, UINT nHeight = 2);
	virtual ~CPlaneMeshIlluminatedTextured();
};

/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
class CPlaneMeshNormalMapTextured : public CMeshIlluminatedTextured
{
public:
	CPlaneMeshNormalMapTextured(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, UINT nWidth = 2, UINT nHeight = 2);
	virtual ~CPlaneMeshNormalMapTextured();
};
