...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
CNormalMapTexturedShader::CNormalMapTexturedShader()
{
}
...
D3D12_INPUT_LAYOUT_DESC CNormalMapTexturedShader::CreateInputLayout()
{
...
D3D12_SHADER_BYTECODE CNormalMapTexturedShader::CreateVertexShader(ID3DBlob **ppd3dShaderBlob)
{
	return(CShader::CompileShaderFromFile(L"Shaders.hlsl", "VSTexturedNormalMapLighting", "vs_5_1", ppd3dShaderBlob));
}

D3D12_SHADER_BYTECODE CNormalMapTexturedShader::CreatePixelShader(ID3DBlob **ppd3dShaderBlob)
{
	return(CShader::CompileShaderFromFile(L"Shaders.hlsl", "PSTexturedNormalMapLighting", "ps_5_1", ppd3dShaderBlob));
}

void CNormalMapTexturedShader::CreateShader(ID3D12Device *pd3dDevice, ID3D12RootSignature *pd3dGraphicsRootSignature)
{
	m_nPipelineStates = 1;
	m_ppd3dPipelineStates = new ID3D12PipelineState*[m_nPipelineStates];
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
CParallaxMapTexturedShader::CParallaxMapTexturedShader()
{
}
...
D3D12_INPUT_LAYOUT_DESC CParallaxMapTexturedShader::CreateInputLayout()
{
	UINT nInputElementDescs = 5;
	D3D12_INPUT_ELEMENT_DESC *pd3dInputElementDescs = new D3D12_INPUT_ELEMENT_DESC[nInputElementDescs];
...
D3D12_SHADER_BYTECODE CParallaxMapTexturedShader::CreateVertexShader(ID3DBlob **ppd3dShaderBlob)
{
	return(CShader::CompileShaderFromFile(L"Shaders.hlsl", "VSTexturedNormalParallaxMapLighting", "vs_5_1", ppd3dShaderBlob));
}

D3D12_SHADER_BYTECODE CParallaxMapTexturedShader::CreatePixelShader(ID3DBlob **ppd3dShaderBlob)
{
	return(CShader::CompileShaderFromFile(L"Shaders.hlsl", "PSTexturedNormalParallaxMapLighting", "ps_5_1", ppd3dShaderBlob));
}

void CParallaxMapTexturedShader::CreateShader(ID3D12Device *pd3dDevice, ID3D12RootSignature *pd3dGraphicsRootSignature)
{
	m_nPipelineStates = 1;
	m_ppd3dPipelineStates = new ID3D12PipelineState*[m_nPipelineStates];
