...
void CGameObject::UpdateShaderVariables(ID3D12GraphicsCommandList *pd3dCommandList)
{
	...
	XMStoreFloat4x4(&m_pcbMappedGameObject->m_xmf4x4World, XMMatrixTranspose(xmmtxWorld));
	XMStoreFloat4x4(&m_pcbMappedGameObject->m_xmf4x4InverseWorld, XMMatrixTranspose(XMMatrixInverse(NULL, xmmtxWorld)));
...
////////////////////////////////////////////////////////////////////////////////////////////////////
//
CIlluminatedTexturedRotatingObject::CIlluminatedTexturedRotatingObject(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, ID3D12RootSignature *pd3dGraphicsRootSignature, int nMeshes) : CRotatingObject(nMeshes)
{
	CTexture *pTexture = new CTexture(1, RESOURCE_TEXTURE2D, 0, 1);
	pTexture->LoadTextureFromFile(pd3dDevice, pd3dCommandList, L"Image/BrickDiffuse2.dds", RESOURCE_TEXTURE2D, 0);

	CMaterial *pCubeMaterial = new CMaterial();
	pCubeMaterial->SetTexture(pTexture);
	pCubeMaterial->SetReflection(1);

	SetMaterial(pCubeMaterial);

	CPlaneMeshIlluminatedTextured *pMesh = new CPlaneMeshIlluminatedTextured(pd3dDevice, pd3dCommandList, 10.0f, 10.0f);
	SetMesh(0, pMesh);
	...
	pShader->CreateShaderResourceViews(pd3dDevice, pTexture, 0, 5);
...
CIlluminatedTexturedRotatingObject::~CIlluminatedTexturedRotatingObject()
{
}

////////////////////////////////////////////////////////////////////////////////////////////////////
//
CNormalMappedRotatingObject::CNormalMappedRotatingObject(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, ID3D12RootSignature *pd3dGraphicsRootSignature, int nMeshes) : CRotatingObject(nMeshes)
{
	m_xmf3RotationAxis = XMFLOAT3(0.0f, 1.0f, 0.0f);

	CTexture *pTexture = new CTexture(2, RESOURCE_TEXTURE2D, 0, 2);
	pTexture->LoadTextureFromFile(pd3dDevice, pd3dCommandList, L"Image/BrickDiffuse2.dds", RESOURCE_TEXTURE2D, 0);
	pTexture->LoadTextureFromFile(pd3dDevice, pd3dCommandList, L"Image/BrickNormal2.dds", RESOURCE_TEXTURE2D, 1);
	...
	CNormalMapTexturedShader *pShader = new CNormalMapTexturedShader();
	pShader->CreateShader(pd3dDevice, pd3dGraphicsRootSignature);
	pShader->CreateShaderVariables(pd3dDevice, pd3dCommandList);
...
CNormalMappedRotatingObject::~CNormalMappedRotatingObject()
{
}

////////////////////////////////////////////////////////////////////////////////////////////////////
//
CParallaxNormalMappedRotatingObject::CParallaxNormalMappedRotatingObject(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, ID3D12RootSignature *pd3dGraphicsRootSignature, int nMeshes) : CRotatingObject(nMeshes)
{
	CTexture *pTexture = new CTexture(3, RESOURCE_TEXTURE2D, 0, 3);
	pTexture->LoadTextureFromFile(pd3dDevice, pd3dCommandList, L"Image/BrickDiffuse2.dds", RESOURCE_TEXTURE2D, 0);
	pTexture->LoadTextureFromFile(pd3dDevice, pd3dCommandList, L"Image/BrickNormal2.dds", RESOURCE_TEXTURE2D, 1);
	pTexture->LoadTextureFromFile(pd3dDevice, pd3dCommandList, L"Image/BrickHeight2.dds", RESOURCE_TEXTURE2D, 2);
	...
	CParallaxMapTexturedShader *pShader = new CParallaxMapTexturedShader();
	pShader->CreateShader(pd3dDevice, pd3dGraphicsRootSignature);
	pShader->CreateShaderVariables(pd3dDevice, pd3dCommandList);
...
CParallaxNormalMappedRotatingObject::~CParallaxNormalMappedRotatingObject()
{
}
