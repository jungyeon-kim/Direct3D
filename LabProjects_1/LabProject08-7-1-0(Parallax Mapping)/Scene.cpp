...
void CScene::BuildLightsAndMaterials()
{
	...
	m_pLights->m_pLights[2].m_xmf4Diffuse = XMFLOAT4(0.984f, 0.984f, 0.984f, 1.0f);
...
void CScene::BuildObjects(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList)
{
	...
	CPlaneMeshNormalMapTextured *pMesh = new CPlaneMeshNormalMapTextured(pd3dDevice, pd3dCommandList, 10, 10);

	CNormalMappedRotatingObject *pNormalMappedRotatingObject = new CNormalMappedRotatingObject(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature, 1);
	pNormalMappedRotatingObject->SetPosition(XMFLOAT3(5.0f, -5.0f, 15.0f));
	pNormalMappedRotatingObject->SetRotationAxis(XMFLOAT3(0.0f, 1.0f, 0.0f));
//	pNormalMappedRotatingObject->SetRotationSpeed(30.0f);
	pNormalMappedRotatingObject->SetMesh(0, pMesh);
	m_ppObjects[0] = pNormalMappedRotatingObject;

	CParallaxNormalMappedRotatingObject *pParallaxNormalMappedRotatingObject = new CParallaxNormalMappedRotatingObject(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature, 1);
	pParallaxNormalMappedRotatingObject->SetPosition(XMFLOAT3(-5.0f, -5.0f, 15.0f));
	pParallaxNormalMappedRotatingObject->SetRotationAxis(XMFLOAT3(0.0f, 1.0f, 0.0f));
//	pParallaxNormalMappedRotatingObject->SetRotationSpeed(30.0f);
	pParallaxNormalMappedRotatingObject->SetMesh(0, pMesh);
	m_ppObjects[1] = pParallaxNormalMappedRotatingObject;
...
ID3D12RootSignature *CScene::CreateGraphicsRootSignature(ID3D12Device *pd3dDevice)
{
	...
	pd3dDescriptorRanges[1].BaseShaderRegister = 0; //Diffuse
	pd3dDescriptorRanges[1].RegisterSpace = 0;
	pd3dDescriptorRanges[1].OffsetInDescriptorsFromTableStart = 0;

	pd3dDescriptorRanges[2].RangeType = D3D12_DESCRIPTOR_RANGE_TYPE_SRV;
	pd3dDescriptorRanges[2].NumDescriptors = 1;
	pd3dDescriptorRanges[2].BaseShaderRegister = 1; //Normal
	pd3dDescriptorRanges[2].RegisterSpace = 0;
	pd3dDescriptorRanges[2].OffsetInDescriptorsFromTableStart = 0;

	pd3dDescriptorRanges[3].RangeType = D3D12_DESCRIPTOR_RANGE_TYPE_SRV;
	pd3dDescriptorRanges[3].NumDescriptors = 1;
	pd3dDescriptorRanges[3].BaseShaderRegister = 2; //Parallax
	...
	pd3dRootParameters[5].DescriptorTable.pDescriptorRanges = &pd3dDescriptorRanges[1]; //Diffuse
	pd3dRootParameters[5].ShaderVisibility = D3D12_SHADER_VISIBILITY_PIXEL;

	pd3dRootParameters[6].ParameterType = D3D12_ROOT_PARAMETER_TYPE_DESCRIPTOR_TABLE;
	pd3dRootParameters[6].DescriptorTable.NumDescriptorRanges = 1;
	pd3dRootParameters[6].DescriptorTable.pDescriptorRanges = &pd3dDescriptorRanges[2]; //Normal
	pd3dRootParameters[6].ShaderVisibility = D3D12_SHADER_VISIBILITY_ALL;

	pd3dRootParameters[7].ParameterType = D3D12_ROOT_PARAMETER_TYPE_DESCRIPTOR_TABLE;
	pd3dRootParameters[7].DescriptorTable.NumDescriptorRanges = 1;
	pd3dRootParameters[7].DescriptorTable.pDescriptorRanges = &pd3dDescriptorRanges[3]; //Parallax
