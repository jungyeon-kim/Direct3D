...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
CGridQuadPatchShader::CGridQuadPatchShader()
{
}
...
D3D12_INPUT_LAYOUT_DESC CGridQuadPatchShader::CreateInputLayout()
{
...
D3D12_RASTERIZER_DESC CGridQuadPatchShader::CreateRasterizerState()
{
	D3D12_RASTERIZER_DESC d3dRasterizerDesc;
	::ZeroMemory(&d3dRasterizerDesc, sizeof(D3D12_RASTERIZER_DESC));
...
D3D12_SHADER_BYTECODE CGridQuadPatchShader::CreateVertexShader(ID3DBlob** ppd3dShaderBlob)
{
	return(CShader::CompileShaderFromFile(L"Shaders.hlsl", "VSQuadPatch", "vs_5_1", ppd3dShaderBlob));
}

D3D12_SHADER_BYTECODE CGridQuadPatchShader::CreatePixelShader(ID3DBlob** ppd3dShaderBlob)
{
	return(CShader::CompileShaderFromFile(L"Shaders.hlsl", "PSQuadPatch", "ps_5_1", ppd3dShaderBlob));
}

D3D12_SHADER_BYTECODE CGridQuadPatchShader::CreateHullShader(ID3DBlob** ppd3dShaderBlob)
{
	return(CShader::CompileShaderFromFile(L"Shaders.hlsl", "HSQuadPatch", "hs_5_1", ppd3dShaderBlob));
}

D3D12_SHADER_BYTECODE CGridQuadPatchShader::CreateDomainShader(ID3DBlob** ppd3dShaderBlob)
{
	return(CShader::CompileShaderFromFile(L"Shaders.hlsl", "DSQuadPatch", "ds_5_1", ppd3dShaderBlob));
}

void CGridQuadPatchShader::CreateShader(ID3D12Device* pd3dDevice, ID3D12RootSignature* pd3dGraphicsRootSignature)
{
	if (pd3dGraphicsRootSignature)
	{
		m_pd3dGraphicsRootSignature = pd3dGraphicsRootSignature;
