...
//	m_fRotationSpeed = 15.0f;
	...
	pTexture->LoadTextureFromFile(pd3dDevice, pd3dCommandList, L"Image/rocks2.dds", RESOURCE_TEXTURE2D, 0);
...
CNormalMappedRotatingObject::CNormalMappedRotatingObject(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, ID3D12RootSignature *pd3dGraphicsRootSignature, int nMeshes) : CRotatingObject(nMeshes)
{
	...
	pTexture->LoadTextureFromFile(pd3dDevice, pd3dCommandList, L"Image/rocks2.dds", RESOURCE_TEXTURE2D, 0);
	pTexture->LoadTextureFromFile(pd3dDevice, pd3dCommandList, L"Image/RocksNormal.dds", RESOURCE_TEXTURE2D, 1);
	...
	CCubeMeshNormalMapTextured *pCubeMesh = new CCubeMeshNormalMapTextured(pd3dDevice, pd3dCommandList, 24.0f, 24.0f, 24.0f);
	SetMesh(0, pCubeMesh);
