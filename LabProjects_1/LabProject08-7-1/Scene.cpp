...
void CScene::BuildObjects(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList)
{
	...
	m_ppObjects[0] = new CIlluminatedTexturedRotatingObject(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature, 1);
	m_ppObjects[0]->SetPosition(XMFLOAT3(+17.0f, 0.0f, 55.0f));

	m_ppObjects[1] = new CNormalMappedRotatingObject(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature, 1);
	m_ppObjects[1]->SetPosition(XMFLOAT3(-17.0f, 0.0f, 55.0f));
