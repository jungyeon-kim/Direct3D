...
void CGameFramework::BuildObjects()
{
	...
	m_pPostProcessingShader = new CPostProcessingByMonochromeShader();
	m_pPostProcessingShader->CreateShader(m_pd3dDevice, m_pScene->GetGraphicsRootSignature(), 1);

	D3D12_CPU_DESCRIPTOR_HANDLE d3dRtvCPUDescriptorHandle = m_pd3dRtvDescriptorHeap->GetCPUDescriptorHandleForHeapStart();
	d3dRtvCPUDescriptorHandle.ptr += ::gnRtvDescriptorIncrementSize * m_nSwapChainBuffers;

	m_pPostProcessingShader->BuildObjects(m_pd3dDevice, m_pd3dCommandList, &d3dRtvCPUDescriptorHandle);
...
{    
	...
	m_pPostProcessingShader->OnPreRenderTarget(m_pd3dCommandList, 0, NULL, m_d3dDsvDepthStencilBufferCPUHandle);
	...
	m_pPostProcessingShader->Render(m_pd3dCommandList, m_pCamera, NULL);
