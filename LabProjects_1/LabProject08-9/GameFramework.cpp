...
void CGameFramework::BuildObjects()
{
	...
	m_pPostProcessingShader->BuildObjects(m_pd3dDevice, m_pd3dCommandList, NULL);
...
{    
	...
	m_pPostProcessingShader->UpdateTextureResource(m_pd3dCommandList, m_ppd3dSwapChainBackBuffers[m_nSwapChainBufferIndex]);
//	m_pd3dCommandList->ClearDepthStencilView(m_d3dDsvDepthStencilBufferCPUHandle, D3D12_CLEAR_FLAG_DEPTH | D3D12_CLEAR_FLAG_STENCIL, 1.0f, 0, 0, NULL);
