...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
CTextureAddComputeShader::CTextureAddComputeShader()
{
}
...
D3D12_SHADER_BYTECODE CTextureAddComputeShader::CreateComputeShader(ID3DBlob **ppd3dShaderBlob)
{
	return(CShader::CompileShaderFromFile(L"Shaders.hlsl", "CSAddTextures", "cs_5_1", ppd3dShaderBlob));
}

void CTextureAddComputeShader::CreateShaderVariables(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList)
{
}

void CTextureAddComputeShader::UpdateShaderVariables(ID3D12GraphicsCommandList *pd3dCommandList)
{
}

void CTextureAddComputeShader::ReleaseShaderVariables()
{
}

void CTextureAddComputeShader::ReleaseUploadBuffers()
{
}

void CTextureAddComputeShader::Dispatch(ID3D12GraphicsCommandList *pd3dCommandList, UINT cxThreadGroups, UINT cyThreadGroups, UINT czThreadGroups)
{
