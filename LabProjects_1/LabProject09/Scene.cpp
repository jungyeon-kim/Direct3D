...
void CScene::BuildObjects(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList)
{
	...
	m_pTexture->LoadTextureFromFile(pd3dDevice, pd3dCommandList, L"Image/InputA.dds", RESOURCE_TEXTURE2D, 0);
	m_pTexture->LoadTextureFromFile(pd3dDevice, pd3dCommandList, L"Image/InputC.dds", RESOURCE_TEXTURE2D, 1);
