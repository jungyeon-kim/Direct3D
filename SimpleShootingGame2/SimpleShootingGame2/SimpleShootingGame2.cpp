...
int APIENTRY _tWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPTSTR lpCmdLine, int nCmdShow)
{
	...
	::LoadString(hInstance, IDC_SIMPLESHOOTINGGAME2, szWindowClass, MAX_LOADSTRING);
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon = ::LoadIcon(hInstance, MAKEINTRESOURCE(IDI_SIMPLESHOOTINGGAME2));
